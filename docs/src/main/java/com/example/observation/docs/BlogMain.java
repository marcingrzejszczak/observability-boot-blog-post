...
package com.example.observation.docs;
...
public class BlogMain {
	public static void main(String... args) {
		...
		System.out.println("Will do the conversion from [" + inputFile + "] to [" + outputFile + "]");
		if (!inputFile.exists()) {
			System.out.println("There's no file [" + inputFile + "], skipping file generation");
			return;
		}
		new BlogMain().convert(inputFile, outputFile);
	}
